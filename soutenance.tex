...
\large  \textbf{Why it is useful to  we research written language understanding?} \hfill
\vspace{1cm}
\begin{columns}
\column{0.5\textwidth}
...
%\begin{frame}
%\begin{itemize}
%	\item \textbf{What to do with our HLM?}
%	\begin{itemize}
%		\item We chose to solve Word Sense Induction and Disambiguation (WSI/WSD)
%		\item Elemental NLP tasks that are naturally solved using the distributional hypothesis
%	\end{itemize}
%\end{itemize}
%\end{frame}
